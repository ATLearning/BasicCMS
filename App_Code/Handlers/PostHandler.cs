...
public class PostHandler : IHttpHandler, IReadOnlySessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        {
            throw new HttpException(401, "You dont have permission to see this");
        }
        ...
        if ((mode == "edit" || mode == "delete") && WebUser.HasRole(UserRoles.Author))
        {
            ...
            {
                throw new HttpException(401, "You cant do that");
            }
        }
    ...
    private static void EditPost(int id,string title, string content, string slug, 
        string datePublished, int authorId, IEnumerable<int> tags)
    {
